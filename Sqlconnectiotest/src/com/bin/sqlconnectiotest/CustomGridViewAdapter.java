...
public class CustomGridViewAdapter extends BaseAdapter{
 ...
 int [] imageId;
    ...
    public CustomGridViewAdapter(MainActivity mainActivity, String[] prgmNameList, int[] prgmImages) {
        ...
        View rowView;
         ...
         rowView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
            	...
            	{
            		case 0 :
            			Intent myIntent = new Intent(context, BookComplaints.class);
						context.startActivity(myIntent);
            			break;
            		case 1:
            			Intent myIntent1 = new Intent(context, ViewComplaints.class);
